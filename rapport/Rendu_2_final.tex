...
\begin{figure}[!ht]
  \centering
  \includegraphics[angle=90,width=0.9\textwidth]{Rendu2.final/state.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[angle=90,width=0.9\textwidth]{Rendu2.final/render.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[angle=90,width=0.9\textwidth]{Rendu2.final/engine.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[angle=90,width=0.8\textwidth]{Rendu2.final/ai.png}
  \caption{Diagramme de classe associé au moteur de jeu fait via DIA}
\end{figure}
