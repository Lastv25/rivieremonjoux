...
//Fonction pour l'affichage du titre du testingvoid affichagebeauTest(std::string testname){
...
int main(int argc, char *const *argv)
{
  if (argc == 2) {
    if ( !strcmp(argv[1],"listen") ){
      affichagebeauTest("listen");
      try {
          ServicesManager servicesManager;
          VersionService* verServ = new VersionService();
          std::unique_ptr<AbstractService> p1 (verServ);
