...
//Network Get request
int CheckPlayersCommand::getPlayerList(){
...
CheckPlayersCommand::CheckPlayersCommand ():Command(){
  this->commandTypeId = CheckPlayers;
}
CheckPlayersCommand::~CheckPlayersCommand (){
}
CommandTypeId CheckPlayersCommand::getCommandTypeId (){
  return this->commandTypeId;
}
void CheckPlayersCommand::execute (state::State* state){
  int playersNumber = getPlayerList();
  state->setPlayerConnected(playersNumber);
  cout <<playersNumber<<endl;
}
void CheckPlayersCommand::executeInv (state::State* state){
}
